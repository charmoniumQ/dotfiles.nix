  ...
  home = {
    packages = with pkgs; [
      ...
      (pkgs.writeShellScriptBin "homedesk" ''
        ...
        ${pkgs.hyprland}/bin/hyprctl keywords monitor $laptop,preferred,3192x698,2
        ${pkgs.hyprland}/bin/hyprctl keywords monitor $acer,preferred,1272x280,1
        ${pkgs.hyprland}/bin/hyprctl keywords monitor $dell,preferred,4320x0,1,transform,3
